...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Reporte Técnico</h1>
    ...
    <div class="content" id="appFormularioIndex">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'get-tecnico-lab', 'method'=>'get']) !!}
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            {!! Form::select('elemento_id', \App\Models\Lab\Elemento::orderBy('nombre')->get()->pluck('nombre', 'id')->toArray(), isset($_GET['elemento_id']) ? $_GET['elemento_id'] : null, ['class' => 'form-control', 'required','id' => 'elemento_id' ]) !!}
                        </div>
                ...
                @include('lab.reportes.table_tecnico')
            </div>
        </div>
    ...
    <script>
        function exportarAPdf() {
            ...
            if (inicio == '' || fin == '') {
                ...
                window.open("/lab/get-finalizados-pdf/" + inicio + '/' + fin + '/' + elemento);
            }
        }

        function exportarAExcel() {
            var nombreArchivo = 'reporteTecnico' + "_{{ $fecha_inicial }}" + '_AL_' + "{{ $fecha_final}}" + '.xls';
