...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Egresos Caja</h1>
    ...
    <div class="content" id="appFormularioIndex">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'get-egresos-lab', 'method'=>'get']) !!}
                ...
                @include('lab.reportes.table_egresos')
            </div>
        </div>
    ...
    <script>
        function exportarAPdf() {
            ...
            if (inicio == '' || fin == '') {
                ...
                window.open("/lab/get-egresos-pdf/" + inicio + '/' + fin);
            }
        }

        function exportarAExcel() {
            var nombreArchivo = 'reporteEgresosCaja' + "_{{ $fecha_inicial }}" + '_AL_' + "{{ $fecha_final}}" + '.xls';
