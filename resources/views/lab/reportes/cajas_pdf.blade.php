...
<div id="parent" style="padding-left: 25px; font-family: Arial, Helvetica, sans-serif; margin-top: -12px">
    ...
    <div class="centro" style="font-family: Arial, Helvetica, sans-serif;">
        <br><br>
        <h2 style="margin-top: 1px; color: #042E44"> REPORTE DE CAJA</h2>
        ...
        <table class="table table-bordered"
            ...
            @foreach($ingresos as $ingreso)
                ...
                <tr style="font-size: 11px; font-weight: normal; text-align: center">
                    ...
                    <td style="padding-left: 6px"> {{ $ingreso->glosa }}</td>
                    <td style="padding-left: 6px"> {{ $ingreso->metodo }}</td>
                    <td style="padding-left: 6px"> {{ number_format($ingreso->sumatoria, 2) }}</td>
                    <td style="padding-left: 6px">{{ $ingreso->cantidad }}</td>
        ...
        <table class="table table-bordered"
            ...
            @foreach($egresos as $egreso)
                ...
                <tr style="font-size: 11px; font-weight: normal; text-align: center">
                    <td style="padding-left: 6px"> {{  $loop->iteration }}</td>
                    <td style="padding-left: 6px"> {{ $egreso->glosa }}</td>
                    <td style="padding-left: 6px"> {{ $egreso->metodo }}</td>
                    <td style="padding-left: 6px"> {{ number_format($egreso->sumatoria, 2) }}</td>
                </tr>
