<head>
    <title>Muestras Finalizadas</title>
</head>
...
<div id="parent" style="padding-left: 25px; font-family: Arial, Helvetica, sans-serif; margin-top: -12px">
    ...
    <div class="centro" style="font-family: Arial, Helvetica, sans-serif;">
        <br><br>
        <h2 style="margin-top: 1px; color: #042E44"> REPORTE DE MUESTRAS FINALIZADAS</h2>
        ...
        <table class="table table-bordered"
            ...
            @foreach($ensayos as $ensayo)
                ...
                <tr style="font-size: 11px; font-weight: normal; text-align: center">
                    ...
                    <td style="padding-left: 6px"> {{ date('d/m/y H:i', strtotime($ensayo->recepcion->fecha_aceptacion)) }}</td>
                    <td style="padding-left: 6px"> {{ $ensayo->recepcion->codigo_pedido }}</td>
                    <td style="padding-left: 6px"> {{ $ensayo->lote }}</td>
                    <td style="padding-left: 6px"> {{ $ensayo->recepcion->cliente->nombre }}</td>
                    <td style="padding-left: 6px"> {{ $ensayo->recepcion->cliente->nit }}</td>
                    <td style="padding-left: 6px"> {{ $ensayo->resultado_elemento }}</td>
                </tr>
