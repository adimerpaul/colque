<div >
    <div id="modalIngreso" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span>Ingreso</span> Insumo</h4>
                </div>
                <div class="modal-body">

                    <div>
                        {!! Form::hidden('insumo_id', null, ['class' => 'form-control', 'id'=>'idInsumo']) !!}
                        {!! Form::hidden('tipo', 'Ingreso', ['class' => 'form-control']) !!}
