<div class="table-responsive">
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        <tr>
            ...
            <th colspan="3" style=" border: 1px solid black; text-align: center">CU</th>
        ...
        <tr>
            <th style=" border: 1px solid black;">% Cu</th>
        ...
        @foreach($formularios as $formulario)
            <tr id="{{'form'. $formulario->id}}">
                ...
                <td style=" border: 1px solid black;">{{$formulario->cotizacion_cu}}</td>
...
<script type="application/javascript">
    ...
    var sumaPesoNetoHumedo = 0, sumaPesoNetoSeco = 0, sumaNetoVenta=0,
        sumaPesoFinoCu = 0, sumaLeyCu = 0, sumaCotizacionCu = 0, sumaCotizacionCuFinal = 0;
    ...
    function seleccionar(contador, formularioId) {
        if ($("#" + contador).is(':checked')) {
            ...
            sumaCotizacionCu = parseFloat(sumaCotizacionCu) + (parseFloat(table.rows[parseInt(contador) + 1].cells[14].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[parseInt(contador) + 1].cells[11].innerHTML.replace(/,/g, ".")));
            sumaPesoFinoCu = parseFloat(sumaPesoFinoCu) + parseFloat(table.rows[parseInt(contador) + 1].cells[13].innerHTML.replace(/,/g, "."));
            sumaLeyCu = ((parseFloat(sumaPesoFinoCu) / parseFloat(sumaPesoNetoSeco)) * 100);
            sumaCotizacionCuFinal = parseFloat(sumaCotizacionCu) / parseFloat(sumaPesoNetoSeco);

            sumaNetoVenta = parseFloat(sumaNetoVenta) + parseFloat(table.rows[parseInt(contador) + 1].cells[16].innerHTML.replace(/,/g, "."));
        ...
        document.getElementById("leyCuSeleccionados").innerHTML = appVenderLotes.arraySeleccionados.length === 0 ? "- Cu %: " : "- Cu %: " + sumaLeyCu.toFixed(2);
        document.getElementById("cotizacionCuSeleccionados").innerHTML = appVenderLotes.arraySeleccionados.length === 0 ? "- Cu Cotización Diaria: " : "- Cu Cotización Diaria: " + sumaCotizacionCuFinal.toFixed(2);
