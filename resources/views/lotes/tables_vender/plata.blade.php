    ...
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        @foreach($formularios as $formulario)
            <tr id="{{'form'. $formulario->id}}">
                ...
                <td style=" border: 1px solid black; background-color: #00838F; color:white"> @foreach($formulario->laboratorio_promedio as $lab)
                ...
                <td style=" border: 1px solid black;">{{number_format($formulario->cotizacion_promedio_ag,2, ',', '')}}</td>
...
<script type="application/javascript">
    ...
    var sumaPesoNetoHumedo = 0, sumaPesoNetoSeco = 0, sumaNetoVenta=0,
        sumaPesoFinoAg = 0, sumaLeyAg = 0, sumaCotizacionAg = 0, sumaCotizacionAgFinal = 0;
    ...
    function seleccionar(contador, formularioId) {
        if ($("#" + contador).is(':checked')) {
            ...
            sumaCotizacionAg = parseFloat(sumaCotizacionAg) + (parseFloat(table.rows[parseInt(contador) + 1].cells[14].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[parseInt(contador) + 1].cells[11].innerHTML.replace(/,/g, ".")));
            sumaPesoFinoAg = parseFloat(sumaPesoFinoAg) + parseFloat(table.rows[parseInt(contador) + 1].cells[13].innerHTML.replace(/,/g, "."));
        ...
        document.getElementById("leyAgSeleccionados").innerHTML = appVenderLotes.arraySeleccionados.length === 0 ? "- Ag DM: " : "- Ag DM: " + sumaLeyAg.toFixed(2);
