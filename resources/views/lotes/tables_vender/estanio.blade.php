<div class="table-responsive">
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        <tr>
            ...
            <th colspan="3" style=" border: 1px solid black; text-align: center">SN</th>
        ...
        @foreach($formularios as $formulario)
            <tr id="{{'form'. $formulario->id}}">
                ...
                <td style=" border: 1px solid black;">{{$formulario->cotizacion_sn}}</td>
...
<script type="application/javascript">
    ...
    function seleccionar(contador, formularioId) {
        if ($("#" + contador).is(':checked')) {
            ...
            sumaCotizacionSn = parseFloat(sumaCotizacionSn) + (parseFloat(table.rows[parseInt(contador) + 1].cells[14].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[parseInt(contador) + 1].cells[11].innerHTML.replace(/,/g, ".")));
            sumaPesoFinoSn = parseFloat(sumaPesoFinoSn) + parseFloat(table.rows[parseInt(contador) + 1].cells[13].innerHTML.replace(/,/g, "."));
        ...
        document.getElementById("leySnSeleccionados").innerHTML = appVenderLotes.arraySeleccionados.length === 0 ? "- Sn %: " : "- Sn %: " + sumaLeySn.toFixed(2);
        document.getElementById("cotizacionSnSeleccionados").innerHTML = appVenderLotes.arraySeleccionados.length === 0 ? "- Sn Cotización Diaria: " : "- Sn Cotización Diaria: " + sumaCotizacionSnFinal.toFixed(2);
