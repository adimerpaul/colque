...
<script type="application/javascript">
    ...
    function seleccionar(contador, formularioId) {
        if ($("#" + contador).is(':checked')) {
            ...
            sumaCotizacionZn = parseFloat(sumaCotizacionZn) + (parseFloat(table.rows[parseInt(contador) + 1].cells[14].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[parseInt(contador) + 1].cells[11].innerHTML.replace(/,/g, ".")));

            sumaPesoFinoZn = parseFloat(sumaPesoFinoZn) + parseFloat(table.rows[parseInt(contador) + 1].cells[13].innerHTML.replace(/,/g, "."));
