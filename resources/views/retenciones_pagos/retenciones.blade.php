    ...
    <div class="content" id="appFormularioIndex">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'retenciones-pagos.index', 'method'=>'get']) !!}
                        <div class="form-group col-sm-4">
                            {!! Form::label('txtBuscar', 'Buscar por:') !!}
                            {!! Form::text('txtBuscar', isset($_GET['txtBuscar']) ?$_GET['txtBuscar']: null, ['class' => 'form-control', 'placeholder'=>'Glosa, Comprobante']) !!}
                        </div>
                ...
                @include('retenciones_pagos.table')
            </div>
        </div>
