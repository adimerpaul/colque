        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;" id="cotizacionznTd"
                    class="znTd">{{round($formulario->cotizacion_zn,3)}}</td>
                ...
                <td style=" border: 1px solid black;" class="agTd"> @foreach($formulario->laboratorio_promedio as $lab)
                        @if($lab->simbolo=='Ag'){{round(($lab->promedio * $formulario->peso_neto_seco / 10000),5)}}  @endif
                    @endforeach
                </td>
                <td style=" border: 1px solid black;"
                    class="agTd">{{round($formulario->cotizacion_ag,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyZn = 0,
        sumaHumedadKg = 0, sumaPesoFinoZn = 0
        , sumaPesoFinoAg = 0, sumaTratamiento = 0,
        sumaLaboratorio = 0
        , sumaComision = 0, sumaCotizacionZn = 0, sumaPesoNetoSeco = 0,
        sumaValorTonelada=0
    ...
    for (var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoZn = parseFloat(sumaPesoFinoZn) + parseFloat(table.rows[i].cells[14].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionZn = parseFloat(sumaCotizacionZn) + (parseFloat(table.rows[i].cells[12].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, ".")));
