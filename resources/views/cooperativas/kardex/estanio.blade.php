...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeySn = 0, sumaHumedadKg = 0, sumaPesoFinoSn = 0
        ...
        , sumaComision = 0, sumaCotizacionSn = 0, sumaPesoNetoSeco = 0
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoSn = parseFloat(sumaPesoFinoSn) + parseFloat(table.rows[i].cells[14].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionSn = parseFloat(sumaCotizacionSn) + (parseFloat(table.rows[i].cells[12].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, ".")));
