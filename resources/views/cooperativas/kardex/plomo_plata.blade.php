        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;" id="cotizacionpbTd"
                    class="pbTd">{{round($formulario->cotizacion_pb,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyPb = 0,
        sumaHumedadKg = 0, sumaPesoFinoPb = 0
        ...
        for (var i = 0; i < JSON.parse(campos).length; i++) {
            if (!JSON.parse(campos)[i].visible) {
                if (JSON.parse(campos)[i].codigo == 'ag'
                    || JSON.parse(campos)[i].codigo == 'pb' || JSON.parse(campos)[i].codigo == 'retencionesDeLey'
