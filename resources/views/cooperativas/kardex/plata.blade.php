        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;"
                    class="agTd">{{round($formulario->cotizacion_promedio_ag,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyAg = 0, sumaHumedadKg = 0
        ...
        , sumaComision = 0, sumaCotizacionAg = 0, sumaPesoNetoSeco = 0
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoAg = parseFloat(sumaPesoFinoAg) + parseFloat(table.rows[i].cells[14].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionAg = parseFloat(sumaCotizacionAg) + (parseFloat(table.rows[i].cells[12].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, ".")));
