...
<script>
    ...
    var table = document.getElementById("kardex-tabla"),sumaLeyZn = 0, sumaPesoFinoZn = 0
    ...
    for (var i = 3; i < (table.rows.length - 1); i++) {
        sumaPesoFinoZn = parseFloat(sumaPesoFinoZn) + parseFloat(table.rows[i].cells[7].innerHTML.replace(/,/g, "."));
