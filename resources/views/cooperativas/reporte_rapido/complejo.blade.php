<div class="table-responsive">
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        <thead>
        <tr>
            <th colspan="23" style="text-align: center; border: 0px white !important">COLQUECHACA MINING LTDA.
...
<script>
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoZn = parseFloat(sumaPesoFinoZn) + parseFloat(table.rows[i].cells[11].innerHTML.replace(/,/g, "."));

        sumaPesoNetoSeco = parseFloat(sumaPesoNetoSeco) + parseFloat(table.rows[i].cells[5].innerHTML.replace(/,/g, "."));
        sumaValorTonelada= parseFloat(sumaValorTonelada) + (parseFloat(table.rows[i].cells[5].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[12].innerHTML.replace(/,/g, ".")));
    }
