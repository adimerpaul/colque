...
<div class="table-responsive">
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        <thead>
        <tr>
            <th colspan="19" style="text-align: center; border: 0px white !important">COLQUECHACA MINING LTDA.
        ...
        <tr>
            <th style=" border: 1px solid black;" id="sn" class="sn">% Ley</th>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"),  sumaLeySn = 0, sumaPesoFinoSn = 0
       sumaValorTonelada=0, sumaPesoNetoSeco = 0,
        nroDescRet=parseInt("{{$nroDescRet}}");

    for(var i = 3; i < (table.rows.length - 1); i++) {
        sumaPesoFinoSn = parseFloat(sumaPesoFinoSn) + parseFloat(table.rows[i].cells[7].innerHTML.replace(/,/g, "."));

        sumaPesoNetoSeco = parseFloat(sumaPesoNetoSeco) + parseFloat(table.rows[i].cells[5].innerHTML.replace(/,/g, "."));
        sumaValorTonelada= parseFloat(sumaValorTonelada) + (parseFloat(table.rows[i].cells[5].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[8].innerHTML.replace(/,/g, ".")));
