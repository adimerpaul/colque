...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaLeyCu = 0, sumaPesoFinoCu = 0, sumaValorTonelada=0
        , sumaPesoNetoSeco = 0,
        nroDescRet=parseInt("{{$nroDescRet}}");

    for(var i = 3; i < (table.rows.length - 1); i++) {
        sumaPesoFinoCu = parseFloat(sumaPesoFinoCu) + parseFloat(table.rows[i].cells[7].innerHTML.replace(/,/g, "."));
