        ...
        <table
            ...
            <tr style="font-size: 11px; ">
                ...
                <td class="center"
                    ...
                    <div style="height:140px; width: 100%; overflow:hidden">
                        ...
                        <div style=" float:right; color: transparent; height:80px; width: 100%">
                            ...
                            @if(!is_null($formularioLiquidacion->cliente->firma) && ($formularioLiquidacion->cliente->firma)!='blanco.png')
                ...
                <td class="center"
                    ...
                    <div style="height:140px;  width: 100%; overflow:hidden">
                        <br><br>
                        @if($formularioLiquidacion->estado==\App\Patrones\Estado::Liquidado OR $formularioLiquidacion->estado==\App\Patrones\Estado::Composito OR $formularioLiquidacion->estado==\App\Patrones\Estado::Vendido)
                            <div style=" float:right; color: transparent; height:80px; width: 100%">
                                @if(!is_null($formularioLiquidacion->usuario_liquidacion_android) && ($formularioLiquidacion->usuario_liquidacion_android->personal->firma)!='blanco.png')
                                    <img
                                        src="{{ 'firmas/'.$formularioLiquidacion->usuario_liquidacion_android->personal->firma}}"
                                        alt="."
                                        style="height: 100%; width: 25%">
                                @else
                                    <img src="{{ 'images/fondo.png'}}" alt="."
                            ...
                            @if(!is_null($formularioLiquidacion->usuario_liquidacion_android->personal->nombre_completo))
                                {{ $formularioLiquidacion->usuario_liquidacion_android->personal->nombre_completo}}
                            @else
                                {{ 'DANIEL AVENDAÑO' }}
                            @endif
                        @else
