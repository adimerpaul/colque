    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'formularioLiquidacions.kardex', 'method'=>'get']) !!}
                    ...
                    @if($productoLetra==='A')
                        @include('reportes.kardex_zinc_plata')
                    @elseif($productoLetra==='B')
                        @include('reportes.kardex_plomo_plata')
                    @elseif($productoLetra==='C')
                        @include('reportes.kardex_complejo')
                    @elseif($productoLetra==='D')
                        @include('reportes.kardex_estanio')
                    @elseif($productoLetra==='E')
                        @include('reportes.kardex_plata')
                    @elseif($productoLetra==='F')
                        @include('reportes.kardex_antimonio_oro')
                    @elseif($productoLetra==='G')
                        @include('reportes.kardex_cobre')
                    @else
                        @include('reportes.kardex_todo')
                    @endif
