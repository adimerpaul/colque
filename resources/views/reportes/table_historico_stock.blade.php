...
<div class="table-responsive">
    <table class="table table-striped"style=" border: 1px solid black;" >
        ...
        <tbody>
        @foreach($reporteHistoricoStock as $reporte)
            <tr>
...
<div class="table-responsive">
    <table class="table table-striped"style=" border: 1px solid black;" id="historicoProductoStock">
        <thead>
        <tr>
            <th style=" border: 1px solid black; text-align: center">#</th>
            <th style=" border: 1px solid black; text-align: center">Mes</th>
        ...
        <tbody>
        @foreach($reporteHistoricoProductoStock as $reporte)
            <tr>
                <td style=" border: 1px solid black;">{{$loop->iteration}}</td>
                <td style=" border: 1px solid black;">{{ $reporte->fecha }}</td>
