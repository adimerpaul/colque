    ...
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;" class="agTd">{{round($formulario->cotizacion_promedio_ag,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyAg = 0, sumaHumedadKg = 0
        ...
        , sumaComision = 0, sumaCotizacionAg = 0, sumaPesoNetoSeco = 0, sumaValorTonelada=0
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoAg = parseFloat(sumaPesoFinoAg) + parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionAg = parseFloat(sumaCotizacionAg) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[16].innerHTML.replace(/,/g, ".")));
    ...
    $(document).ready(function(){
        for(var i = 0; i < JSON.parse(campos).length; i++) {
            if(!JSON.parse(campos)[i].visible){
                if(JSON.parse(campos)[i].codigo == 'ag' || JSON.parse(campos)[i].codigo == 'retencionesDeLey'
