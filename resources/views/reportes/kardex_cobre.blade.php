    ...
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;" id="cotizacionCuTd" class="cuTd">{{round($formulario->cotizacion_cu,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyCu = 0, sumaHumedadKg = 0, sumaPesoFinoCu = 0
        ...
        , sumaComision = 0, sumaCotizacionCu = 0, sumaPesoNetoSeco = 0,  sumaValorTonelada=0
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoCu = parseFloat(sumaPesoFinoCu) + parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionCu = parseFloat(sumaCotizacionCu) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[16].innerHTML.replace(/,/g, ".")));
