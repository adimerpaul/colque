    ...
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        <tr>
            ...
            <th colspan="44" style="text-align: center; border: 0px white !important">COLQUECHACA MINING LTDA.
                ...
                @if($fechaInicio)<br>PRODUCTO: ANTIMONIO (SB)@endif
                <br>
        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;" id="cotizacionSbTd" class="sbTd">{{round($formulario->cotizacion_sb,3)}}</td>
                ...
                <td style=" border: 1px solid black;" id="cotizacionAuTd" class="auTd">{{round($formulario->cotizacion_au,3)}}</td>
...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeySb = 0, sumaHumedadKg = 0, sumaPesoFinoSb = 0
        , sumaPesoFinoAu = 0, sumaCajaSalud = 0, sumaComibol = 0, sumaFencominNorpo = 0, sumaFencomin = 0, sumaGastosAdmin = 0
        , sumaTransporte = 0, sumaLeyes = 0, sumaViaticos = 0, sumaTratamiento = 0, sumaLaboratorio = 0
        , sumaComision = 0, sumaCotizacionSb = 0, sumaPesoNetoSeco = 0, sumaValorTonelada=0
    ...
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoSb = parseFloat(sumaPesoFinoSb) + parseFloat(table.rows[i].cells[15].innerHTML.replace(/,/g, "."));
        sumaPesoFinoAu = parseFloat(sumaPesoFinoAu) + parseFloat(table.rows[i].cells[18].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionSb = parseFloat(sumaCotizacionSb) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[16].innerHTML.replace(/,/g, ".")));
        sumaPesoNetoSeco = parseFloat(sumaPesoNetoSeco) + parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, "."));
        sumaCotizacionAu = parseFloat(sumaCotizacionAu) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[19].innerHTML.replace(/,/g, ".")));
    ...
    $(document).ready(function(){
        for(var i = 0; i < JSON.parse(campos).length; i++) {
            if(!JSON.parse(campos)[i].visible){
                if(JSON.parse(campos)[i].codigo == 'sb' || JSON.parse(campos)[i].codigo == 'au' || JSON.parse(campos)[i].codigo == 'retencionesDeLey'
