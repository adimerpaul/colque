...
<script>
    ...
    var table = document.getElementById("kardex-tabla"), sumaRegalia = 0, sumaHumedad = 0, sumaLeyPb = 0, sumaHumedadKg = 0, sumaPesoFinoPb = 0
        ...
        , sumaCuentasCobrar = 0, sumaLeyAg = 0, sumaCotizacionAg = 0, sumaPesoFinoZn = 0, sumaCotizacionZn = 0, sumaLeyZn = 0, sumaPesaje = 0, sumaAporteFundacion = 0;
    for(var i = 3; i < (table.rows.length - 1); i++) {
        ...
        sumaPesoFinoZn = parseFloat(sumaPesoFinoZn) + parseFloat(table.rows[i].cells[21].innerHTML.replace(/,/g, "."));
        sumaCajaSalud = parseFloat(sumaCajaSalud) + parseFloat(table.rows[i].cells[26].innerHTML.replace(/,/g, "."));
        sumaComibol = parseFloat(sumaComibol) + parseFloat(table.rows[i].cells[27].innerHTML.replace(/,/g, "."));
        sumaFencominNorpo = parseFloat(sumaFencominNorpo) + parseFloat(table.rows[i].cells[28].innerHTML.replace(/,/g, "."));
        sumaFencomin = parseFloat(sumaFencomin) + parseFloat(table.rows[i].cells[29].innerHTML.replace(/,/g, "."));
        sumaGastosAdmin = parseFloat(sumaGastosAdmin) + parseFloat(table.rows[i].cells[30].innerHTML.replace(/,/g, "."));
        sumaTransporte = parseFloat(sumaTransporte) + parseFloat(table.rows[i].cells[32].innerHTML.replace(/,/g, "."));
        sumaLeyes = parseFloat(sumaLeyes) + parseFloat(table.rows[i].cells[33].innerHTML.replace(/,/g, "."));
        sumaViaticos = parseFloat(sumaViaticos) + parseFloat(table.rows[i].cells[34].innerHTML.replace(/,/g, "."));
        // sumaCuentasCobrar = parseFloat(sumaCuentasCobrar) + parseFloat(table.rows[i].cells[38].innerHTML.replace(/,/g, "."));
        sumaAporteFundacion = parseFloat(sumaAporteFundacion) + parseFloat(table.rows[i].cells[40].innerHTML.replace(/,/g, "."));
        sumaTratamiento = parseFloat(sumaTratamiento) + parseFloat(table.rows[i].cells[42].innerHTML.replace(/,/g, "."));
        sumaLaboratorio = parseFloat(sumaLaboratorio) + parseFloat(table.rows[i].cells[43].innerHTML.replace(/,/g, "."));
        sumaPesaje = parseFloat(sumaPesaje) + parseFloat(table.rows[i].cells[44].innerHTML.replace(/,/g, "."));
        sumaComision = parseFloat(sumaComision) + parseFloat(table.rows[i].cells[45].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionZn = parseFloat(sumaCotizacionZn) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[22].innerHTML.replace(/,/g, ".")));
        sumaValorTonelada= parseFloat(sumaValorTonelada) + (parseFloat(table.rows[i].cells[13].innerHTML.replace(/,/g, ".")) * parseFloat(table.rows[i].cells[23].innerHTML.replace(/,/g, ".")));
    ...
    document.getElementById("pesoFinoAgTotal").innerHTML = (sumaPesoFinoAg.toFixed(2));
