<div id="modalAnticipo" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar cobro de anticipos</h4>
            </div>
            <div class="modal-body">
                <div>
                    {!! Form::hidden('idAnticipo', null, ['class' => 'form-control', 'name'=>'idAnticipo', 'id'=>'idAnticipo']) !!}
                    ...
                    <div class="form-group col-sm-12">
                        {!! Form::label('metodo_pago', 'Método de cobro :*') !!}
                    ...
                    <div class="form-group col-sm-12" id="nroRecibo">
                        ...
                        {!! Form::text('numero_recibo', null, ['class' => 'form-control', 'maxlength' => '20', 'required', 'id' => 'numero_recibo']) !!}
                    </div>
