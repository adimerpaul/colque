...
<div class="centro" style="padding-left: 25px; font-family: Arial, Helvetica, sans-serif;">
    <div style="width: 100%;">
        <div style="width: 70%; float:left;">
            <p style="font-size: 13px">
                ...
                @else
                    <strong>NÚMERO:</strong> {{$anticipo->id}}
                @endif
                <br>
    ...
    <div>
        ...
        <p style="font-size: 13px">
            <strong>COMPRADOR:</strong> {{$anticipo->venta->comprador->razon_social}}<br>
            @if($anticipo->motivo) <strong>CONCEPTO:</strong> {{$anticipo->motivo}}<br>@endif
            <strong>LOTE:</strong> {{$anticipo->venta->lote}} <br>
    ...
    <table style="width: 100%">
        ...
        @foreach($historial as $anticipo)
            <tr style="font-size: 13px; font-weight: normal; text-align: left ">
                ...
                <td style="width: 100px">{{ date( 'd/m/Y', strtotime($anticipo->created_at))}}</td>
