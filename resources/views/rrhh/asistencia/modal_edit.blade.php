            ...
            <div class="modal-body">
             {!! Form::hidden('idAsistencia', null, ['class' => 'form-control', 'name'=>'idAsistencia', 'id'=>'idAsistencia']) !!}
                ...
                <div class="form-group">    
                    ...
                    {!! Form::datetime('hora_marcada', null, ['class' => 'form-control', 'required', 'name' => 'fecha', 'id' => 'fecha']) !!}
                </div>
                <div class="form-group col-sm-12" style="text-align: right">
                    {!! Form::submit('Guardar', ['class' => 'btn btn-primary', 'name'=>'guardar','id'=>'guardar','onclick' => "return confirm('¿Está seguro de editar la asistencia?')"]) !!}
                </div>
