...
@section('content')
    ...
    <div class="content" id="appFormularioIndex">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'pagos.anticipos', 'method'=>'get']) !!}
                ...
                @include('anticipos.table_anticipos')
            </div>
        </div>
    ...
    <script>
        ...
        function exportarAExcel() {
            var nombreArchivo = 'reporteAnticipos' + "{{$anticipos->currentPage()}}" + "_{{ $fechaInicial }}" + '_AL_' + "{{ $fechaFinal}}" + '.xls';
