        ...
        <div class="hijo">
            ...
            <div style="font-size: large">
                <p class="text-justify">
                    Estimado (a) cliente: {{ $factura->factura_original['razon_social']  }} <br>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="text-right" style="width: 50%"><strong>Tipo:</strong></td>
                        <td>{{ $factura->tipo }}</td>
                    </tr>
                    <tr>
                        <td class="text-right" style="width: 50%"><strong>Fecha:</strong></td>
