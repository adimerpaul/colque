    ...
    <table style=" border: 1px solid black;" class="table table-striped" id="kardex-tabla" name="kardex-tabla">
        ...
        @foreach($formularios as $formulario)
            <tr>
                ...
                <td style=" border: 1px solid black;"
                    class="agTd">{{number_format($formulario->cotizacion_promedio_ag,2, ',', '')}}</td>
...
<script type="application/javascript">
    ...
    var table = document.getElementById("kardex-tabla"), sumaHumedad = 0, sumaLeyAg = 0,
        sumaPesoFinoAg = 0, costoMercaderia = 0
        , sumaComisionExterna = 0, sumaLaboratorio = 0, sumaBonoTransporte = 0, sumaBonoCliente = 0
        , sumaPromocion = 0, sumaCotizacionAg = 0, sumaPesoNetoSeco = 0, sumaProProductor = 0
        , sumaPesaje = 0
    ...
    for (var i = 0; i < (tbody.rows.length - 3); i++) {
        ...
        sumaPesoFinoAg = parseFloat(sumaPesoFinoAg) + parseFloat(tbody.rows[i].cells[8].innerHTML.replace(/,/g, "."));
        ...
        sumaCotizacionAg = parseFloat(sumaCotizacionAg) + (parseFloat(tbody.rows[i].cells[6].innerHTML.replace(/,/g, ".")) * parseFloat(tbody.rows[i].cells[9].innerHTML.replace(/,/g, ".")));
