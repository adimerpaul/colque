...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}">Colquechaca</a>
    </div>

    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Reiniciar Contraseña (Mínimo 8 caracteres (1 mayúscula, 1 minúscula y 1 nùmero))</p>
        ...
        <form method="post" action="{{ url('/password/reset') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                <input type="password" name="password_confirmation" class="form-control" placeholder="Confirmación de contraseña">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
