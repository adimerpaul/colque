<div id="modalPrestamo" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar pago de prestamo</h4>
            </div>
            <div class="modal-body">
                <div>
                    {!! Form::hidden('idPrestamo', null, ['class' => 'form-control', 'name'=>'idPrestamo', 'id'=>'idPrestamo']) !!}
