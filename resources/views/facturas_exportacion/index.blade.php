...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Facturas Exportacion de Mineral</h1>
        <br>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'getExportacionMineral', 'method'=>'get']) !!}
                ...
                @include('facturas_exportacion.table')
            </div>
        </div>
    ...
    {!! Form::open(['route' => 'anularExportacion', 'id' => 'formularioModal']) !!}
    @include("facturas_exportacion.modal_factura")
    {!! Form::close() !!}
@endsection
