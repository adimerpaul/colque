...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Historial Cuentas por cobrar</h1>
        <br>
    </section>
    <div class="content" id="appFormularioIndex">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => 'cuentas-cobrar-total', 'method'=>'get']) !!}
                        <div class="form-group col-sm-4">
                            {!! Form::label('txtBuscar', 'Buscar por:') !!}
                            {!! Form::text('txtBuscar', isset($_GET['txtBuscar']) ?$_GET['txtBuscar']: null, ['class' => 'form-control', 'placeholder'=>'Monto, Glosa']) !!}
                        </div>
                ...
                @include('cuentas_cobrar.table_total')
            </div>
        </div>
