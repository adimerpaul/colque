    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar pago de liquidación</h4>
            </div>
            <div class="modal-body">
                <div>
                    {!! Form::hidden('idFormulario', null, ['class' => 'form-control', 'name'=>'idFormulario', 'id'=>'idFormulario']) !!}
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><input style="border: 0; background-color:white" readonly class="form-control" name="cliente" id="cliente"></td>
                        </tr>
                    ...
                    <div class="form-group col-sm-12" id="nroRecibo">
                        ...
                        {!! Form::text('numero_recibo', null, ['class' => 'form-control', 'maxlength' => '150', 'required', 'id' => 'numero_recibo']) !!}
                    </div>
