<div id="modalDevolucion" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar pago de devoluciones</h4>
            </div>
            <div class="modal-body">
                <div>
                    {!! Form::hidden('idBono', null, ['class' => 'form-control', 'name'=>'idBono', 'id'=>'idBono']) !!}
