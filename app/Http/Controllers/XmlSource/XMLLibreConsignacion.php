...
class XMLLibreConsignacion extends XMLbase
{
    /**
     ...
     **/
    public static function generate($request, $ciclo, $mes, $gestion, $name = 'facturaElectronicaLibreConsignacion', $type = 'facturasLibreConsignacion')
    {

        //return $mes;
        $type = storage_path($type);

        $month = XMLLibreConsignacion::toMonthNumber($mes);
        //return $month;
