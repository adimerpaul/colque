...
class XMLCompraVenta extends XMLbase
{
    /**
     ...
     **/
    public static function generate($request, $ciclo, $mes, $gestion, $name = 'facturaElectronicaCompraVenta', $type = 'facturasCompraVenta')
    {

        //return $mes;
        $type = storage_path($type);

        $month = XMLCompraVenta::toMonthNumber($mes);
        //return $month;
